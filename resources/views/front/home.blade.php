                ...
                <div class="col-lg-3">
                    <div class="cat-card">
                        <div class="left">
                            ...
                            <img src="{{asset('uploads/category/'.$category->image)}}" alt="" style="height:100px;">
                            @endif
                        </div>
                        <div class="right">
                            <div class="cat-data">
                    ...
                    <div class="card product-card">
                        ...
                        <div class="card-body text-center mt-3">
                            ...
                            <div class="price mt-2">
                               ...
                               @if($product->compare_price > 0) <span class="h6 text-underline"><del>${{$product->compare_price}}</del></span>@endif
                            </div>
                        </div>                        
                    </div>                                               
                </div> 
