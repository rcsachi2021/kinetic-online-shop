					...
					<div class="container-fluid">
                        ...
                        <form action="">
							<div class="card-header">
                                <a href="javascript:void(0);" onclick="window.location.href='{{route("products.index")}}'" class="btn btn-default btn-sm">Reset</a>
                                    ...
                                    @endphp
										<tr>
											...
											<td>
                                                ...
                                                <img src="{{asset('uploads/product/'.$productImage->name)}}" class="img-thumbnail" width="50" >
                                                @else
